...
layer_params = {
  ...
  custom_recipes: { setup: [ "firefox", "python", "jenkins::server", "rvm::user_install", "jenkins-configuration::jobs", "jenkins-configuration::views", "jenkins-configuration::config" ] }
}
